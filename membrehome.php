...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link" href="membrehome.php?p=commissions">
        <i class="fas fa-book-reader"></i>
        <span>Vos Commissions</span></a>
      </li>
      
      <li class="nav-item">
        <a class="nav-link" href="membrehome.php?p=concours">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php
                                    ...
                                    ?></span>
                <img class="img-profile rounded-circle" src="img/membre/<?php if (isset($_SESSION['photo'])) {
                                        echo $_SESSION['photo'];
                                        } else
                                            echo 'no-photo.jpg'
                                        ?>" >
            ...
            <div class="container-fluid" id="main-content">
                ...
                <?php
                    if( isset($_GET['p']) && $_GET['p'] != ""){
                        if($_GET['p']=="commissions"){
                            include_once './pages/membre/commissions.php';
                        }elseif ($_GET['p']=="postulation"){
                            include_once './pages/membre/postulation.php';
                        }elseif ($_GET['p']=="profile"){
                          include_once './pages/membre/profile.php';
                        }elseif ($_GET['p']=="concours"){
                          include_once './pages/membre/concours.php';
                        } 
                        else{
